...
const FAQComponent = () => {
  ...
  return (
    <div id="faqs" style={{ backgroundColor: "#6094fc", padding: "40px 0", marginTop: "20px" }}>
            ...
            <div className="search-bar" style={{ display: "flex", alignItems: "center", marginBottom: "20px" }}>
              <input
                ...
                style={{
                  ...
                  fontSize: "16px",
                  backgroundImage: `url('img/search.png')`, // Replace with the path to your search icon image
          ...
          {filteredFaqs.map((faq) => (
            ...
            >
              <div
                className="faq"
                style={{
                  backgroundColor: "#6094fc",
                  boxShadow: "0 4px 6px rgba(104, 124, 252, 0.5)",
                  color: "#fff",
                  padding: "20px",
                  marginBottom: "20px"
                }}
